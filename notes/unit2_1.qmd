...
<!-- In the introduction to this unit, we ran into a puzzle: we want to talk about how fast something is moving at a single instant in time, but speed seems to require *two* points in time to measure — a change in position and a change in time. Let's make this precise, and then figure out how to push past it.
...
[Interactive graph on Desmos](https://www.desmos.com/calculator/mw9d2h6lyj)

![](images/unit2_1_instvel.png)
:::
